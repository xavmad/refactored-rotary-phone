...
setTimeout(() => {
  ...
  groupImages.forEach((img, i) => {
    ...
    // spacing grows with image size
    const angle  = i * 0.85;
    const radius =
      Math.sqrt(i) * (IMAGE_SIZE + PADDING);
