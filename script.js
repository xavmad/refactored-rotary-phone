...
function smoothCamera() {
  if (zoomAnimating) {
    ...
    if (t === 1) {
      ...
      // sync targets so pan works immediately after zoom
      targetScale = scale;
      targetOriginX = originX;
      targetOriginY = originY;
    }
  } else {
    // continuous easing for pan (and idle camera)
    originX += (targetOriginX - originX) * 0.15;
    originY += (targetOriginY - originY) * 0.15;
  }
